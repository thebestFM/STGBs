...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        args.seed = run
        args.save_model_name = f'{args.model_name}_{args.dataset_name}_{args.negative_sample_strategy}_seed{args.seed}'
        ...
        if args.model_name == 'DyGFormer':
            ...
            dynamic_backbone = TIDFormer(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
        ...
        for epoch in range(args.num_epochs):
            ...
            for batch_idx, train_data_indices in enumerate(train_idx_data_loader_tqdm):
                ...
                _, batch_neg_dst_node_ids = train_neg_edge_sampler.sample(size=len(batch_src_node_ids), batch_src_node_ids=batch_src_node_ids, batch_dst_node_ids=batch_dst_node_ids,
                                                                          current_batch_start_time=min(batch_node_interact_times), current_batch_end_time=max(batch_node_interact_times))
