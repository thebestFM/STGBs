...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='lastfm',
                        choices=['wikipedia', 'reddit', 'mooc', 'lastfm', 'enron', 'SocialEvo', 'uci'])
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    parser.add_argument('--model_name', type=str, default='TIDFormer', help='name of the models',
                        choices=['DyGFormer','TIDFormer'])
    ...
    parser.add_argument('--num_bidirectional', type=int, default=2, help='number of bidirectional interactions')
    parser.add_argument('--num_time_segment', type=int, default=4, help='number of time segments')
    parser.add_argument('--BIE_feature_dim', type=int, default=8, help='dim of the BIE feature for link prediction')
    parser.add_argument('--calendar_base', type=str, default='yearly', help='calendar-based information to use',
                        choices=['weekly', 'monthly', 'yearly']) 
    parser.add_argument('--kernel_size', type=int, default=5, help='kernel size of moving average')
...
def get_node_classification_args():
    ...
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    parser.add_argument('--model_name', type=str, default='TIDFormer', help='name of the model',
                        choices=['DyGFormer', 'TIDFormer'])
    parser.add_argument('--gpu', type=int, default=0, help='number of gpu to use')
    parser.add_argument('--num_neighbors', type=int, default=32, help='number of neighbors to sample for each node')
    ...
    parser.add_argument('--num_bidirectional', type=int, default=2, help='number of bidirectional interactions')
    parser.add_argument('--num_time_segment', type=int, default=4, help='number of time segments')
    parser.add_argument('--calendar_base', type=str, default='weekly', help='calendar-based information to use',
                        choices=['weekly', 'monthly', 'yearly']) 
    parser.add_argument('--kernel_size', type=int, default=5, help='kernel size of moving average')
    parser.add_argument('--walk_length', type=int, default=1, help='length of each random walk')
    parser.add_argument('--time_gap', type=int, default=2000, help='time gap for neighbors to compute node features')
